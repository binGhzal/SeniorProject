...
- [x] Define app-side schema for trips, events, and diagnostics
- [x] Define event-clip metadata schema for circular buffer windows (±10-20s around events)
- [x] Decide cloud storage scope (alerts-only vs full telemetry)
- [x] Define synchronization conflict and replay rules
- [x] Define encryption and privacy controls for sensitive data
- [x] Define DSAR-compatible export/delete workflow for user-requested data actions
