...
- Week 1: run stakeholder review to freeze app platform scope.
- Week 1: produce 8-12 user stories with acceptance tests linked to telemetry fields.
- Week 1: publish MVP vs post-MVP matrix and update `docs/FEATURES.md`.
