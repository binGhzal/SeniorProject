...
\begin{center}
	...
	\\ \vspace{0.7cm}
	\textsc{\large ITBP481: Senior Graduation Project II}\\ \vspace{0.3cm}
	\textsc{\large Final Project Report }\\ \vspace{0.3cm}
	...
	\begin{center}
		\begin{tabular}{@{}L{0.34\linewidth}L{0.18\linewidth}L{0.24\linewidth}@{}}
			Suhail Alblooshi  & 202230373 & Computer Engineering \\
			Mohammed Alshamsi & 202107716 & Computer Engineering \\
			Ahmed Mustafa     & 700041219 & Computer Engineering \\
			Abdulla Alshamsi  & 202112121 & Computer Engineering \\
		\end{tabular}
	\end{center}
	...
	\parbox{0.94\linewidth}{\centering\textbf{\large A project report submitted in partial fulfillment of the requirements for the Bachelor of Science degree at the College of Information Technology, United Arab Emirates University}} \\ \vspace{1.3cm}
	{\today}
\end{center}
...
Compared with the broader GP1 concept (which included EEG and distraction plus head-pose modules), SGP2 intentionally delivers an MVP-aligned scope focused on fatigue, crash, and telemetry reliability. EEG and distraction analytics remain planned future extensions and are tracked in the project TODO roadmap.
...
\section{Social, Cultural, and Policy Constraints}
...
\section{System Modules and Setup}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|L{0.24\textwidth}|L{0.36\textwidth}|L{0.28\textwidth}|}
		\hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|L{0.29\textwidth}|L{0.30\textwidth}|L{0.31\textwidth}|}
		\hline
		\textbf{Test}               & \textbf{Component Scope}          & \textbf{Expected Outcome}                           \\ \hline
		IMU connection check        & IMU wrapper return format         & Returns 3-tuple; test passes                        \\ \hline
		Fatigue-logic check         & Fatigue trigger condition         & Drowsy=True with EAR<0.25; test passes              \\ \hline
		Crash integration path      & Crash threshold \& alert wiring   & Alert publish invoked for total\_g>2.5; test passes \\ \hline
		Offline queue placeholder   & Connectivity fallback queueing    & Messages are queued while transport is unavailable  \\ \hline
		Storage retention pruning   & Local retention enforcement       & Records older than retention window are pruned      \\ \hline
		Architecture contract cycle & End-to-end runtime cycle contract & Crash/fatigue/status events emitted in one cycle    \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|L{0.16\textwidth}|L{0.17\textwidth}|L{0.52\textwidth}|}
		\hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|L{0.28\textwidth}|L{0.25\textwidth}|L{0.32\textwidth}|}
		\hline
...
The remaining open work is tracked in the project TODO files under \path{docs/todo/} and consolidated in \path{docs/IMPLEMENTATION_ROADMAP.md}. The planned sequence is organized into four short sprints: (1) requirements freeze and platform scope finalization, (2) connectivity hardening and fault-recovery policy, (3) storage/privacy hardening with schema and encryption controls, and (4) AI dataset labeling and benchmark validation.
...
\begin{table}[htbp]
	...
	\begin{tabular}{|L{0.40\textwidth}|L{0.20\textwidth}|L{0.28\textwidth}|}
		\hline
...
\begin{table}[h!]
	...
	\small
	\begin{tabular}{|L{0.18\textwidth}|L{0.4\textwidth}|L{0.2\textwidth}|}
		\hline
